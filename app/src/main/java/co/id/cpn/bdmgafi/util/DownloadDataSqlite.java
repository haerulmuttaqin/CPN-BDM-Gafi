...
//    private Button tryAgain;
    ...
    public DownloadDataSqlite(Context contextf/*, ProgressBar progressBar, TextView textProgress, TextView textProgressPercent*//*, Button tryAgain*/) {
        context = contextf;
...
//        this.textProgress.setVisibility(View.VISIBLE);
    ...
    protected Void doInBackground(String... arg0) {
        try {
            ...
            c.connect();
            String PATH = Environment.getExternalStorageDirectory().toString() + Constants.PATH;
...
//           InputStream is = c.getInputStream();
            ...
            if (outputFile.length() > 0) {
                if (sqLiteImporter.unpackZip(Environment.getExternalStorageDirectory().toString() + Constants.PATH, Constants.MASTER_DB_ZIP, Constants.MASTER_DB)) {
...
//            progressBar.setMax(values[1]);
        ...
        Log.w("TAG", "onProgressUpdate: " + values[0] );
